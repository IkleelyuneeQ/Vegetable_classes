...
#
# Deployment: A Streamlit application was developed, allowing users to upload vegetable images and receive real-time predictions. The app includes an Out-of-Distribution (OOD) feature to flag images that do not belong to any trained class.
#
# 3. Results
#
